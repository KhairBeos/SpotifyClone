  ...
  return (
    <>
      <TouchableOpacity
        ...
        onPressIn={() => { if (!disabled) scale.value = withTiming(0.98, { duration: 80 }); }}
        onPressOut={() => { if (!disabled) scale.value = withTiming(1, { duration: 80 }); }}
      ...
      <ActionSheet visible={sheetVisible} onClose={() => setSheetVisible(false)} actions={actions.map(a => ({
        ...a,
